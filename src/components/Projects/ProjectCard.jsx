...
const ProjectCard = ({ title, main,img,demoClick,sourceClick}) => {
  ...
  return (
  <div className="p-5 m-10 md:p-6 flex flex-col w-full md:w-60 bg-blue-300 bg-opacity-30 shadow-xl shadow-slate-900 rounded-2xl hover:opacity-85 duration-300 hover:scale-110 backdrop-blur-sm">
